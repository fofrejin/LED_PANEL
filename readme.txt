...
Для ArduinoOTA краще задати пароль, щоб ніхто несанкціоновано не прошив панель по WiFi. Для цього треба розкоментувати рядок "ArduinoOTA.setPassword((const char *)"radio2017");"
Для зміни кількості свідлодіодних матриць використовуються рядки:
